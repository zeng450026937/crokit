...
#define COMPONENT_MACRO_SELECT_THIRD_ARGUMENT_(...) \
  COMPONENT_MACRO_SELECT_THIRD_ARGUMENT_IMPL_MSVC_(__VA_ARGS__)
#elif
#define COMPONENT_MACRO_SELECT_THIRD_ARGUMENT_(...) \
...
#define COMPONENT_MACRO_SELECT_EXPAND(...) __VA_ARGS__
#define COMPONENT_MACRO_SELECT_THIRD_ARGUMENT_IMPL_MSVC_(...) \
  COMPONENT_MACRO_SELECT_EXPAND(                              \
    COMPONENT_MACRO_SELECT_THIRD_ARGUMENT_IMPL_(__VA_ARGS__))
