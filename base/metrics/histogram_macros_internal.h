...
#define INTERNAL_UMA_HISTOGRAM_ENUMERATION_EXPAND(...) __VA_ARGS__
#define INTERNAL_UMA_HISTOGRAM_ENUMERATION_GET_MACRO_MSVC(...)                 \
  INTERNAL_UMA_HISTOGRAM_ENUMERATION_EXPAND(                                   \
...
// Note: The value in |sample| must be strictly less than |enum_size|.
#define INTERNAL_UMA_HISTOGRAM_ENUMERATION_SPECIFY_BOUNDARY_MSVC(...) \
  INTERNAL_UMA_HISTOGRAM_ENUMERATION_EXPAND(                          \
    INTERNAL_UMA_HISTOGRAM_ENUMERATION_SPECIFY_BOUNDARY(__VA_ARGS__))
