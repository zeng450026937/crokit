...
#ifndef YEALINK_NATIVE_MATE_CONVERTERS_GURL_CONVERTER_H_
#define YEALINK_NATIVE_MATE_CONVERTERS_GURL_CONVERTER_H_
...
#endif  // YEALINK_NATIVE_MATE_CONVERTERS_GURL_CONVERTER_H_
