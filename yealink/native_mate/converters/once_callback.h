...
#ifndef YEALINK_NATIVE_MATE_CONVERTERS_ONCE_CALLBACK_H_
#define YEALINK_NATIVE_MATE_CONVERTERS_ONCE_CALLBACK_H_
...
#endif  // YEALINK_NATIVE_MATE_CONVERTERS_ONCE_CALLBACK_H_
